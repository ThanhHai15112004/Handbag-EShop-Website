                            ...
                            <div class="swiper-wrapper">
                                ...
                                " xml:space="preserve">
                                    ...
                                    C-3.633,346.391,16.109,368.632,40.971,368.632z"></path>
                                            ...
                                            <h5 class="mb-0">
                                                <a href="<?= BASE_URL ?>about">Sản phẩm chất lượng</a>
                                            </h5>
                                        </div>
                                        <div class="hover-effect">
                                            ...
                                            <p class="color-5">Nguyên liệu tươi ngon, quy trình chế biến an toàn, đảm
                                                bảo sức khỏe cho
                                                khách hàng.</p>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="box">
                                        <div class="inner">
                                            ...
                                            <h5 class="mb-0">
                                                <a href="<?= BASE_URL ?>about">Giao hàng nhanh</a>
                                            </h5>
                                        </div>
                                        <div class="hover-effect">
                                            <h5 class="mb-20">
                                            ...
                                            <p class="color-5">Đặt món dễ dàng, giao hàng tận nơi nhanh chóng, phục vụ
                                                tận tâm.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box">
                                        <div class="inner">
                                            <div class="icon mb-28">
                                                <svg enable-background="new 0 0 512.009 512.009" height="512"
                                                    viewBox="0 0 512.009 512.009" width="512"
                                            ...
                                            <h5 class="mb-0">
                                                <a href="<?= BASE_URL ?>about">Dịch vụ thân thiện</a>
                                            </h5>
                                        </div>
                                        <div class="hover-effect">
                                            <h5 class="mb-20">
                                            ...
                                            <p class="color-5">Đội ngũ nhân viên nhiệt tình, thân thiện, luôn sẵn sàng
                                                hỗ trợ khách hàng.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="box">
                                        <div class="inner">
                                            ...
                                            <h5 class="mb-0">
                                                <a href="<?= BASE_URL ?>about">Đặt món siêu tốc</a>
                                            </h5>
                                        </div>
                                        <div class="hover-effect">
                                            <h5 class="mb-20">
                                            ...
                                            <p class="color-5">Đặt món chỉ với vài thao tác, nhận món nhanh chóng, tiện
                                                lợi.</p>
                                        </div>
                                    </div>
                                </div>
