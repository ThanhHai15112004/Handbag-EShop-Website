            ...
            <div class="col-md-12">
                <div class="page-title-inner hidden">
                    ...
                    <div class="breadcrumb flex flex-column items-center wow fadeIn" data-wow-delay=".2s">
                        <h1 class="title center">Về chúng tôi</h1>
                        <ul>
                ...
                <div class="about-content style1 relative radius-20 flex items-center justify-between">
                    ...
                    <div class="content pr-30 mobile-mb-30 mobile-pr0">
                        <h2 class="color-3 title text-spacing-1 mb-25 mt--5">
                            Lịch sử phát triển của Basilico từ năm 1996
                        </h2>
                        <p class="mb-15">
                            Basilico được thành lập với sứ mệnh mang đến những món ăn nhanh chất lượng, an toàn và hợp
                            khẩu vị
                            người Việt. Trải qua nhiều năm phát triển, chúng tôi luôn giữ vững giá trị cốt lõi về chất
                            lượng và
                            dịch vụ tận tâm.
                        </p>
                        <p>
                            Chúng tôi tự hào là thương hiệu Việt, không ngừng đổi mới để phục vụ khách hàng tốt nhất. Từ
                            những
                            chiếc bánh mì kẹp thịt thơm ngon đến các món ăn đa dạng, Basilico luôn là lựa chọn hàng đầu
                            cho mọi
                            gia đình.
                        </p>
                    </div>
                    <div class="inner-box gradient radius-20">
                        ...
                        <p class="font-1 fz-20 lh-1_75 white mb-28">
                            Basilico không chỉ phục vụ các món ăn nhanh chất lượng theo quy trình kiểm soát nghiêm ngặt
                            mà còn
                            mang đến trải nghiệm ẩm thực tuyệt vời cho mọi khách hàng.
                        </p>
                        <h6 class="color-2 italic text-spacing-0_5 color-main mb-0">
                            Anh Minh
                        </h6>
                        <p class="uppercase fz-13 color-7 text-spacing-0_5">
                            Nhà sáng lập Basilico
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="about-content relative radius-20 flex items-center justify-between">
                    ...
                    <div class="content m--8 pl-15">
                        <h2 class="color-3 title text-spacing-1 mb-24 mt--5">
                            Mỗi miếng ăn là một vũ trụ hương vị
                        </h2>
                        <p class="mb-42">
                            Dù bạn là tín đồ của sốt cà chua, mù tạt hay thích các loại sốt đặc biệt, mỗi chiếc burger
                            tại
                            Basilico đều có nét riêng hấp dẫn. Đừng quên thử các loại sốt đặc trưng của chúng tôi để cảm
                            nhận sự
                            khác biệt!
                        </p>
                        <div class="flex">
                            <a href="<?= BASE_URL ?>book-table" class="tf-button">đặt bàn</a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="about-content style1 relative radius-20 flex items-center justify-between">
                    ...
                    <div class="content mobile-mb-30 mt--25">
                        <h2 class="color-3 title text-spacing-1 mb-24">
                            Giao hàng nhanh chóng <br class="show-destop">
                            Tận nơi hoặc mang đi
                        </h2>
                        <p class="mb-20 pr-70">
                            Chúng tôi sử dụng nguyên liệu tươi ngon, đảm bảo chất lượng cho từng món ăn. Basilico luôn
                            đồng hành
                            cùng nông dân Việt Nam để mang đến sản phẩm tốt nhất cho khách hàng.
                        </p>
                        <ul class="icon-list style3 w-full">
                            <li>
                                <span class="color-3">Đặt món & Giao hàng qua ứng dụng</span>
                            </li>
                            <li class="style">
                                <span class="color-3">Giao hàng tận nơi</span>
                            </li>
                            <li>
                                <span class="color-3">Có thể mang đi</span>
                            </li>
                            <li class="style">
                                <span class="color-3">Thanh toán đa nền tảng</span>
                            </li>
                        </ul>
                    </div>
                    <div class="inner-box style2 gradient radius-20">
                        ...
                        <p class="white mb-30">
                            Gọi đặt hàng ngay hoặc đặt online!
                        </p>
                        <div class="flex">
                            <a href="<?= BASE_URL ?>menu-restaurant" class="tf-button flex items-center">đặt hàng trực tuyến</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="swiper-container mySwiper2 w-full h-full">
                            <div class="swiper-wrapper">
                                        ...
                                        <div class="inner">
                                            <div class="icon mb-28">
                                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    viewBox="0 0 511.992 511.992" style="
                                ...
                                " xml:space="preserve">
                                    ...
                                    l-20.479-20.479C80.926,156.836,80.926,150.365,84.919,146.351z"></path>
                                    ...
                                    c0-5.652-4.587-10.24-10.24-10.24H30.732z"></path>
                                    ...
                                    C-3.633,346.391,16.109,368.632,40.971,368.632z"></path>
                                                    </g>
                                                </svg>
                                            </div>
                                        ...
                                        <div class="hover-effect">
                                            <h5 class="mb-20">Sản phẩm chất lượng</h5>
                                            <p class="color-5">
                                                Nguyên liệu tươi ngon, quy trình chế biến an toàn, đảm bảo sức khỏe cho
                                                khách hàng.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="box">
                                        <div class="inner">
                                            ...
                                            <h5 class="mb-0">Giao hàng nhanh</h5>
                                        </div>
                                        <div class="hover-effect">
                                            <h5 class="mb-20">Giao hàng nhanh</h5>
                                            <p class="color-5">
                                                Đặt món dễ dàng, giao hàng tận nơi nhanh chóng, phục vụ tận tâm.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                    <div class="box">
                                        <div class="inner">
                                            ...
                                            <h5 class="mb-0">Dịch vụ thân thiện</h5>
                                        </div>
                                        <div class="hover-effect">
                                            <h5 class="mb-20">Dịch vụ thân thiện</h5>
                                            <p class="color-5">
                                                Đội ngũ nhân viên nhiệt tình, thân thiện, luôn sẵn sàng hỗ trợ khách
                                                hàng.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="box">
                                        <div class="inner">
                                            ...
                                            <h5 class="mb-0">Đặt món siêu tốc</h5>
                                        </div>
                                        <div class="hover-effect">
                                            <h5 class="mb-20">Đặt món siêu tốc</h5>
                                            <p class="color-5">
                                                Đặt món chỉ với vài thao tác, nhận món nhanh chóng, tiện lợi.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <p class="color-3 mb-28">
                                        Đồ ăn rất ngon, phục vụ tận tình. Tôi rất hài lòng với chất lượng và vệ sinh tại
                                        Basilico. Nhân
                                        viên luôn đeo găng tay khi chế biến, cảm giác rất an tâm. Sẽ quay lại nhiều lần
                                        nữa!
                                    </p>
                                    <p class="name color-3">
                                        <span>-</span> Marcus Williams <span>-</span>
                                    </p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <p class="color-3 mb-28">
                                        Không gian sạch sẽ, món ăn đa dạng và hợp khẩu vị. Tôi đánh giá cao sự chuyên
                                        nghiệp của đội ngũ
                                        nhân viên. Rất thích cách phục vụ nhanh chóng ở đây.
                                    </p>
                                    <p class="name color-3">
                                        <span>-</span> Olivia Martin <span>-</span>
                                    </p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <p class="color-3 mb-28">
                                        Tôi thường xuyên đặt món mang về cho gia đình. Thức ăn luôn nóng hổi, đóng gói
                                        cẩn thận. Giá cả
                                        hợp lý, chất lượng vượt mong đợi.
                                    </p>
                                    <p class="name color-3">
                                        <span>-</span> Alex Turner <span>-</span>
                                    </p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <p class="color-3 mb-28">
                                        Mình rất thích các món burger ở Basilico, vị ngon đặc trưng và rất hợp khẩu vị.
                                        Nhân viên nữ
                                        phục vụ rất dễ thương, chu đáo. Sẽ giới thiệu cho bạn bè!
                                    </p>
                                    <p class="name color-3">
                                        <span>-</span> Emma Schneider <span>-</span>
                                    </p>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="testimonial-item">
                                    ...
                                    <p class="color-3 mb-28">
                                        Đồ uống ở đây rất ngon, không gian trẻ trung, năng động. Nhân viên nữ tư vấn
                                        nhiệt tình, mình
                                        cảm thấy rất hài lòng khi đến Basilico.
                                    </p>
                                    <p class="name color-3">
                                        <span>-</span> Sophia Clark <span>-</span>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-3 col-md-6 pd0 wow fadeIn" data-wow-delay=".4s">
                <div class="content-box pd-50 relative h-full tablet-center">
                    ...
                    <div class="relative z-1">
                        ...
                        <h3 class="fz-40 mb-10 text-spacing-1_5">Gặp gỡ đội ngũ</h3>
                        <p class="fz-17 mb-42 white">
                            Các món ăn tại Basilico được chế biến từ nguyên liệu sạch, đảm bảo an toàn thực phẩm và chất
                            lượng.
                        </p>
                        <div class="flex">
                            <a href="<?= BASE_URL ?>teams" class="tf-button">xem đội ngũ</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 pd0 wow fadeIn" data-wow-delay=".8s">
                <div class="content-box pd-50 relative h-full tablet-center">
                    ...
                    <div class="relative z-1">
                        ...
                        <h3 class="fz-40 mb-10 text-spacing-1_5">Gia nhập đội ngũ</h3>
                        <p class="fz-17 mb-42 white">
                            Basilico luôn chào đón các thành viên mới năng động, sáng tạo và đam mê ẩm thực.
                        </p>
                        <div class="flex">
                            <a href="<?= BASE_URL ?>recruitment=" class="tf-button">tham gia ngay hôm nay</a>
                        </div>
                    </div>
                </div>
            </div>
