            ...
            <div class="col-md-12">
                <div class="page-title-inner style2 hidden">
                    <div class="bg-page-title-inner">
                        <img class="parallax" src="assets/images/backgroup/page-title_2.jpg" alt="">
                    </div>
                    ...
                    <div class="breadcrumb flex flex-column items-center wow fadeIn" data-wow-delay=".2s">
                        <h1 class="title center">Liên hệ</h1>
                        <ul>
                            ...
                            <div class="swiper-wrapper">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                    ...
                                                    <g>
                                                        <path
                                                            ...
                                                            fill="#fffefe" opacity="1" data-original="#000000" class="">
                                                        </path>
                                                    </g>
                                                </svg>
                                            </div>
                                            <h5 class="mb-20">Địa chỉ nhà hàng</h5>
                                            <p class="color-5">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                    ...
                                                    <g>
                                                        <path
                                                            ...
                                                            fill="#fffbfb" opacity="1" data-original="#000000" class="">
                                                        </path>
                                                    </g>
                                                </svg>
                                            </div>
                                            <h5 class="mb-20">Email liên hệ</h5>
                                            <p class="color-5">
                                                Hỗ trợ: Basilfastfood@gmail.com <br>
                                                Đặt bàn: Basilico22@gmail.com
                                            </p>
                                        </div>
                                        <div class="hover-effect w-full">
                                            <h5 class="mb-20">Email liên hệ</h5>
                                ...
                                <div class="swiper-slide">
                                    <div class="box">
                                        <div class="inner">
                                            <div class="icon mb-26">
                                                <img src="assets/images/icon/contact-us.png" alt="">
                                            </div>
                                            <h5 class="mb-20">Số điện thoại</h5>
                                            <p class="color-5">
                                                Hỗ trợ: 19008386 <br>
                                                Đặt hàng: 19008386
                                            </p>
                                    ...
                                    <div class="box">
                                        <div class="inner">
                                            <div class="icon mb-26">
                                                <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="512" height="512"
                                                    x="0" y="0" viewBox="0 0 477.849 477.849"
                                                    style="enable-background: new 0 0 512 512" xml:space="preserve">
                                                    <g>
                                                        <path
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tf-title center pb-30 mb-50 wow fadeInUp" data-wow-delay=".2s">
                    <h2 class="mb-16">Gửi liên hệ</h2>
                    <p class="fz-17">
                        Nếu bạn có bất kỳ câu hỏi hoặc thắc mắc nào, hãy gửi cho chúng tôi và chúng tôi sẽ phản hồi
                        trong vòng
                        24 giờ. Chúng tôi luôn sẵn sàng hỗ trợ bạn.
                    </p>
                </div>
            </div>
                ...
                <div class="form-comment style">
                    <form action="#" class="w-full">
                        ...
                        <fieldset class="full mb-40">
                            <textarea placeholder="Nội dung liên hệ..." rows="7" tabindex="5" name="message"
                                class="message" id="message" required=""></textarea>
                        </fieldset>
                        <div class="flex justify-center w-full">
                            <button class="tf-button">Gửi liên hệ</button>
                        </div>
                    </form>
                </div>
            </div>
